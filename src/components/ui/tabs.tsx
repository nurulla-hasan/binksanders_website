  ...
  "group/tabs-list inline-flex w-fit items-center justify-center rounded-lg p-[3px] text-muted-foreground group-data-horizontal/tabs:h-9 group-data-vertical/tabs:h-fit group-data-vertical/tabs:flex-col data-[variant=line]:rounded-none",
  {
    variants: {
      variant: {
        ...
        responsive: "grid h-auto w-full grid-cols-2 bg-muted sm:w-fit",
      },
    },
    defaultVariants: {
      variant: "default",
  ...
  return (
    <TabsPrimitive.Trigger
      ...
      className={cn(
        ...
        "group-data-[variant=responsive]/tabs-list:h-auto group-data-[variant=responsive]/tabs-list:min-h-9 group-data-[variant=responsive]/tabs-list:whitespace-normal group-data-[variant=responsive]/tabs-list:text-center group-data-[variant=responsive]/tabs-list:text-xs sm:group-data-[variant=responsive]/tabs-list:text-sm",
